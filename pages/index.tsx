        ...
        <Flex justify="center">
          <Box px={8} py={6} bgColor="white" rounded="lg" border="solid 2px" borderColor="blue.600" boxShadow="1px 0px 20px lightgray">
            ...
            <Image src="/favicon.ico" width={50}/>
              <Typography.H3 textAlign="center">Welcome to <Image pb={2} src="/logo/funtime_full_logo_blue.png" width={100} verticalAlign="middle" display="inline-block"/> 2022!</Typography.H3>
              <Typography.Body1 color="gray.600" textAlign="center">
