...
import {CreateLeagueFormStepType} from './types';
        ...
        >
          <VStack spacing="20px">
            ...
            <FormControl>
              ...
              <FormHelperText>
                Players must choose a total score for the final game in the week (usually the Monday
                night game). The player (or players) closest to the total score will win if there's
                a tie in the number of correct picks in the week.{' '}
                <strong>We recommend Yes for this feature.</strong>
              </FormHelperText>
            </FormControl>
            <FormControl>
              ...
              <FormHelperText>
                ...
                winner, loser, and total score at the beginning of the season, and there's an extra
                game at the end of the season to see who is closest.
              </FormHelperText>
            </FormControl>
          </VStack>
        </SequentialWizardLayout>
