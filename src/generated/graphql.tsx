...
export type PicksByWeekQuery = { __typename?: 'Query', picksByWeek: { __typename?: 'PicksByWeekResponse', week?: number | null, season?: number | null, canView: boolean, games: Array<{ __typename?: 'Games', gid: number }>, picks: Array<{ __typename?: 'Picks', pickid: number }> } };
...
export const PicksByWeekDocument = gql`
    query PicksByWeek {
  picksByWeek(leagueId: 7, week: 1, override: true) {
    week
    season
    canView
    games {
